            ...
            option +=  " <tr> "
                        ...
                        +   " <td class='align-middle'> "
                          +   "   <div class='input-group quantity mx-auto' style='width: 100px;'> "
                             +    "   <div onclick='minus("+data[i][0].produitId+","+data[i][0].commandeId+")' class='input-group-btn'> " 
                              +     "     <button   class='btn btn-sm btn-primary btn-minus' > "
                               +    "     <i class='fa fa-minus'></i> "
                              +      "    </button> "
                              +    "  </div> "
                              +    "  <input type='text' disabled='' class='form-control form-control-sm bg-secondary text-center' value='"+data[i][2]+"'> "
                              +    "  <div onclick='plus("+data[i][0].produitId+","+data[i][0].commandeId+")' class='input-group-btn'> "
