        ...
        <div class="row px-xl-5">
            <div class="col-lg-8 table-responsive mb-5">
                <table class="table table-bordered text-center mb-0">
                    ...
                    <tbody id="listcart" class="align-middle">
                       <!-- J query list Cart -->
                    </tbody>
                </table>
            </div>
            <div class="col-lg-4">
                ...
                <div class="card border-secondary mb-5">
                    ...
                    <div class="card-body">
                        <div id="total" class="d-flex justify-content-between mb-3 pt-1">
                            
                        </div>
                        
                    </div>
                    <div class="card-footer border-secondary bg-transparent">
                        <div id="total1" class="d-flex justify-content-between mt-2">
                            <!-- -->
